  ...
  <PageHeader title="关系图">
    ...
    <el-card v-loading="loading" :body-style="{ padding: '10px' }" class="mt">
      <div slot="header" class="clearfix">
        <i class="el-icon-info color--primary" style="margin: 0 5px 0 20px;">   天使长/小天使</i>
        <i class="el-icon-info color--red" style="margin: 0 5px 0 0;">   一级粉丝</i>
        <i class="el-icon-info color--purple" style="margin: 0 20px 0 0px;">   二级粉丝</i>
