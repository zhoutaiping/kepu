...
<template>
  <PageHeader :show-title="false" title="">
    <el-radio-group v-model="bindParams.articleType" @change="$refs.DmData.initPage()">
      <el-radio-button :label="1">文 章</el-radio-button>
      <el-radio-button :label="2">公 告</el-radio-button>
    </el-radio-group>
    <DmData
      ref="DmData"
